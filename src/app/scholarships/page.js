      ...
      <section className="mt-32 max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-14">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Explore fully funded scholarships, filter by country, degree, and deadline.
          </p>
        </div>
        ...
        <form
          method="GET"
          action="/scholarships"
          className="bg-white shadow-sm border border-gray-100 rounded-2xl p-5 mb-12 grid md:grid-cols-4 gap-4"
        >
          <input
            type="text"
            name="search"
          ...
          <aside className="space-y-6 sticky top-24">
            ...
            <div className="bg-white border border-gray-100 rounded-2xl p-6 shadow-sm">
              ...
              <ul className="space-y-2 text-sm">
                <li><Link href="/scholarships/daad-scholarship">DAAD Scholarship</Link></li>
                <li><Link href="/scholarships/gates-cambridge">Gates Cambridge</Link></li>
                <li><Link href="/scholarships/fulbright">Fulbright Scholarship</Link></li>
              </ul>
            </div>
            ...
            <div className="bg-white border border-gray-100 rounded-2xl p-6 text-sm text-gray-600 shadow-sm">
              ...
              <p>
                Use filters to quickly find scholarships that match your country, degree level, and deadline.
              </p>
            </div>
